...
parameterType: CONDITION_PARAM_TYPE | (CONDITION_PARAM_CONTAINER LESS parameterType GREATER);
...
NEWLINE |
WHITESPACE |
(LBRACKET NEWLINE? WHITESPACE? RBRACKET) |
(LBRACKET conditionExpression RBRACKET) |
(LBRACE NEWLINE? WHITESPACE? STRING WHITESPACE? COLON NEWLINE? WHITESPACE? conditionExpression COMMA? NEWLINE? WHITESPACE? RBRACE) |
(LBRACE NEWLINE? WHITESPACE? RBRACE)
)|~(RBRACE))*;